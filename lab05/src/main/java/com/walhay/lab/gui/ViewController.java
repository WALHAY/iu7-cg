...
public class ViewController implements Initializable, IView {
	...
	public void onMouseClicked(MouseEvent event) {
		if (event.getButton() == MouseButton.PRIMARY) {
			this.model.addPoint(getPointFromMouseEvent(event));
		}
	}
	...
	public void updateColor(Color color) {
		...
		fillColor.setValue(ColorUtils.toFXColor(color));
	}

	@FXML
	public void modeChange() {
		model.setHoleMode(modeButton.isSelected());
	}
	...
	public void fillFigure() {
		model.fillPolygon(isDelayed(), getDelay());
	}

	@FXML
	public void setColor() {
		model.setFillColor(getColor());
	}
